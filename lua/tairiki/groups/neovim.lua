...
function M.get(c, opts)
	...
	return {
		...
		DiagnosticVirtualTextOk     = { fg = c.diag.ok, bg = opts.diagnostics.background and "none" or "none" },
		DiagnosticVirtualTextHint   = { fg = c.diag.hint, bg = opts.diagnostics.background and "none" or "none" },
		DiagnosticVirtualTextInfo   = { fg = c.diag.info, bg = opts.diagnostics.background and "none" or "none" },
		DiagnosticVirtualTextWarn   = { fg = c.diag.warn, bg = opts.diagnostics.background and "none" or "none" },
		DiagnosticVirtualTextError  = { fg = c.diag.error, bg = opts.diagnostics.background and "none" or "none" },
	}
end
